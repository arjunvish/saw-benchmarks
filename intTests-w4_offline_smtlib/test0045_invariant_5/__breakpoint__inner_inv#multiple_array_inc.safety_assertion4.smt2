...
(assert (not x!2))
(define-fun x!3 () (_ BitVec 64) (bvadd x2 (_ bv1 64)))
(define-fun x!4 () Bool (bvult x!3 x0))
(assert x!4)
(define-fun x!5 () Bool (bvult x!3 x0))
(assert (not x!5))
(check-sat)
(exit)
;./test0045_invariant_5/__breakpoint__inner_inv#multiple_array_inc.safety_assertion4.smt2
